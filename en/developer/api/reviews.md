...
| GET | `/api/review-sets` | — | Common_Review_Schema, EntityTypeIdentitySchema, PaginationSchema, ReviewSetListQuerySchema, getValidatedQueryI18n | `server/api/review-sets/index.get.ts` |
| POST | `/api/review-sets` | executeFreshAuthorizedReviewRuntimeWrite | CreateReviewSetSchema, EntityTypeIdentitySchema, readValidatedBodyI18n | `server/api/review-sets/index.post.ts` |
| GET | `/api/review-sets/lookups/setups` | — | EntityTypeIdentitySchema, PaginationSchema, ReviewSetupLookupQuerySchema, getValidatedQueryI18n | `server/api/review-sets/lookups/setups.get.ts` |
...
| GET | `/api/reviews/[reviewId]/checklist` | canAuthorizeReviewRuntimeAction | — | `server/api/reviews/[reviewId]/checklist.get.ts` |

...
| POST | `/api/approval-templates/[templateId]/retire` | resolveApprovalTemplateScopeContextFromTemplateId | — | `server/api/approval-templates/[templateId]/retire.post.ts` |

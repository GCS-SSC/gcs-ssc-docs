...
L’intégration GC Forms est une extension installée qui peut relier les soumissions de GC Forms à des correspondances de champs GCS. La configuration de l’agence stocke les métadonnées des identifiants et les clés privées chiffrées. La configuration du volet stocke l’identifiant sélectionné, les détails du point de terminaison GC Forms, l’identifiant du formulaire, le comportement de confirmation et les correspondances des destinations.

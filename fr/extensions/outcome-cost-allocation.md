...
Une entente peut avoir un brouillon, une version active et un historique de versions inactives. Répartissez chaque coordonnée résultat-exercice par montant ou par pourcentage. Les valeurs doivent être non négatives, comporter au plus quatre décimales et ne pas dépasser `900 719 925 474,0991`. Les pourcentages sont calculés par rapport au financement de programme de l’exercice, et l’écart d’arrondissement au cent est distribué de façon déterministe.
